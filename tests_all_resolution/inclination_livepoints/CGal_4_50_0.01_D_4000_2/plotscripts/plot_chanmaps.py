...
gname = 'CGal_4_50_0.01' 
outfolder = '/home/user/THESIS/tests_all_resolution/inclination_livepoints/CGal_4_50_0.01_D_4000_2/' 
twostage = 0 
plotmask = 1 
...
image = fits.open('/home/user/THESIS/models/A_MODELS_new/new_attempt/CGal_4_50_0.01/CGal_4_50_0.01.fits') 
	...
	for j in range (0,3): 
		for i in range (0,5): 
			...
			if (j==i==0): 
				...
				bmaj, bmin, bpa = 3/float(xmax-xmin), 3/float(ymax-ymin),0
			...
			ax.plot(xcen,ycen,'x',color='#0FB05A',markersize=7,mew=2) 
			if (i==0 and j==2): 
				clab = r'Contour levels at 2$^n \, c_{min}$, where $c_{min}$ = %s JY/BEAM and n = 0,1,..,8 '%cont 
