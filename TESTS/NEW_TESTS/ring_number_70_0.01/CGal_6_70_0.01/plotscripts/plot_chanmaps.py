...
outfolder = '/home/user/THESIS/NEW_TESTS/ring_number_70_0.001/CGal_6_70_0.01/' 
twostage = 0 
plotmask = 1 
...
image = fits.open('/home/user/THESIS/models_tests/CGal_6_70_0.01/CGal_6_70_0.01.fits') 
	...
	for j in range (0,3): 
		for i in range (0,5): 
			...
			if (j==i==0): 
				...
				bmaj, bmin, bpa = 2.85714/float(xmax-xmin), 2.85714/float(ymax-ymin),0
