...
gname = 'model4' 
outfolder = '/Users/blanca/Documents/TESIS/software/THESIS/scripts/output//model4_D_small/' 
twostage = 0 
plotmask = 1 
...
image = fits.open('/Users/blanca/Documents/TESIS/software/THESIS/test_BBB_enrico/models/model4.fits') 
