...
gname = 'CGal_6_70_0.01' 
outfolder = '/home/user/THESIS/tests_on_inc_different_resolution/CGal_6_70_0.01_B_inc/' 
twostage = 0 
plotmask = 1 
...
image = fits.open('/home/user/THESIS/models/A_MODELS_new/new_attempt/CGal_6_70_0.01/CGal_6_70_0.01.fits') 
	...
	for j in range (0,3): 
		for i in range (0,5): 
			...
			if (j==i==0): 
				...
				bmaj, bmin, bpa = 3.07692/float(xmax-xmin), 3.07692/float(ymax-ymin),0
