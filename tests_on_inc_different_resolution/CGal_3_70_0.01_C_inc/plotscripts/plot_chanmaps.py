...
gname = 'CGal_3_70_0.01' 
outfolder = '/home/user/THESIS/tests_on_inc_different_resolution/CGal_3_70_0.01_C_inc/' 
twostage = 0 
plotmask = 1 
...
image = fits.open('/home/user/THESIS/models/A_MODELS_new/new_attempt/CGal_3_70_0.01/CGal_3_70_0.01.fits') 
	...
	for j in range (0,3): 
		for i in range (0,5): 
			...
			if (j==i==0): 
				...
				bmaj, bmin, bpa = 2.96296/float(xmax-xmin), 2.96296/float(ymax-ymin),0
